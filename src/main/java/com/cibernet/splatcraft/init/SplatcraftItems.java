...
import com.cibernet.splatcraft.item.weapon.SplatRollerItem;
...
public class SplatcraftItems {
    ...
    public static final Item SPLAT_ROLLER = register(SplatRollerItem.id, new SplatRollerItem(new FabricItemSettings().customDamage((stack, amount, entity, breakCallback) -> ClientUtils.getDurabilityForDisplay(stack)).maxCount(1).group(Splatcraft.ItemGroups.WEAPONS), 0.4F, 12.0F, 0.8F, 9.0F,3, 20, 0.1F, false));
    ...
    public static final Item COROCORO_SPLAT_ROLLER = register("corocoro_"+ SplatRollerItem.id, new SplatRollerItem((SplatRollerItem) SPLAT_ROLLER, 0.4F, 12.0F, 0.8F, 0.9F,2, 20, 0.1F, false));
    ...
    public static final Item INKBRUSH = register("inkbrush", new SplatRollerItem((SplatRollerItem) SPLAT_ROLLER, 0.35f, 6f, 0.85f, 2.0f, 1, 5, 0.135f,true));
    ...
    public static final Item OCTOBRUSH = register("octobrush", new SplatRollerItem((SplatRollerItem) SPLAT_ROLLER, 0.5F, 8.0F, 0.95F, 3.2F, 2, 4, 0.18f, true));
    ...
    public static final Item CARBON_ROLLER = register("carbon_roller", new SplatRollerItem((SplatRollerItem) SPLAT_ROLLER, 0.38f, 8f, 0.7f, 4.0f, 2, 14, 0.1f, false));
