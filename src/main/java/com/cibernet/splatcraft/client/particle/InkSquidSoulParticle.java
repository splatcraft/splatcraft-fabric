...
public class InkSquidSoulParticle extends SpriteBillboardParticle {
    ...
    private InkSquidSoulParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, InkedParticleEffect effect, SpriteProvider spriteProvider) {
        super(world, x, y, z, velocityX, velocityY, velocityZ);

        this.colorRed = Math.max(0.018f, effect.getRed() - 0.018f);
        this.colorGreen = Math.max(0.018f, effect.getGreen() - 0.018f);
        this.colorBlue = Math.max(0.018f, effect.getBlue() - 0.018f);
